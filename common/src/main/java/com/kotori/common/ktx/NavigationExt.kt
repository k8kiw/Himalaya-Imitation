...
fun BottomNavigationView.setupWithNavController(
    ...
    navGraphIds.forEachIndexed { index, navGraphId ->
        ...
        LogUtil.d(TAG, "setupWithNavController: $fragmentTag and $graphId")
    ...
    setOnNavigationItemSelectedListener { item ->
        ...
        if (fragmentManager.isStateSaved) {
            ...
            if (selectedItemTag != newlySelectedItemTag) {
                ...
                LogUtil.d(TAG, "setupWithNavController: $firstFragmentTag and $newlySelectedItemTag")
                ...
                if (firstFragmentTag != newlySelectedItemTag) {
                    ...
                    fragmentManager.beginTransaction()
                        ...
                        .commit()
                    LogUtil.d(TAG, "setupWithNavController: $firstFragmentTag")
                }
...
private fun attachNavHostFragment(
    ...
    LogUtil.d(TAG, "attachNavHostFragment: ")
    fragmentManager.beginTransaction()
...
private fun obtainNavHostFragment(
    ...
    LogUtil.d(TAG, "obtainNavHostFragment existingFragment : $existingFragment ")
